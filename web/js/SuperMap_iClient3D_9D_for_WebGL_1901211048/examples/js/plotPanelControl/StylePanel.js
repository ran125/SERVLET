            ...
            switch (updated.name) {
                ...
                case this._displayName[6]:
                    if (updated.group === this._group[10]) {
                        selectFeature.pictureSymbolSize = {x:parseInt(updated.value),y:pictureSymbolSize.y};
                    } else {
                ...
                case this._displayName[7]:
                    if (updated.group === this._group[10]) {
                        selectFeature.pictureSymbolSize = {x:pictureSymbolSize.x,y:parseInt(updated.value)};
                    } else {
